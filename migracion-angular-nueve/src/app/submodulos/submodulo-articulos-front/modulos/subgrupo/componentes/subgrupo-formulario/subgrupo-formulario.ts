...
export class SubgrupoFormulario {
  formGroup: FormGroup;
  mensajesValidacionNombre: MensajesValidacionSubgrupo;
  mensajesValidacionDescripcion: MensajesValidacionSubgrupo;
  mensajesValidacionEmpresaProductora: MensajesValidacionSubgrupo;
  mensajesValidacionCodigo: MensajesValidacionSubgrupo;
...
// contenidoEjecucionConstructor - NO BORRAR ESTA LINEA
  ...
  private encerarConfiguracionFormBuilderNombre() {
    ...
    const argumentos: any = {
      ...
      ejemplo: 'EJ: Res',
      tooltip: 'Ingrese el nombre del subgrupo',
      minLength: 3,
      maxLength: 60,
      min: false,
      max: false,
  ...
  private encerarConfiguracionFormBuilderDescripcion() {
    ...
    const argumentos: any = {
      ...
      tooltip: 'Ingrese la descripción del subgrupo',
      minLength: 3,
      maxLength: 100,
      min: false,
      max: false,
  ...
  private encerarConfiguracionFormBuilderEmpresaProductora() {
    ...
    const argumentos: any = {
      ...
      nombreAPresentarse: ' Empresa productora',
      ejemplo: 'EJ: BOSCH',
      tooltip: 'Ingrese la empresa productora',
      minLength: 3,
      maxLength: 60,
      min: false,
      max: false,
  ...
  private encerarConfiguracionFormBuilderCodigo() {
    ...
    const argumentos: any = {
      ...
      ejemplo: 'EJ: 1',
      tooltip: 'Ingrese el código del subgrupo',
      minLength: 1,
      maxLength: 30,
      min: false,
      max: false,
...
interface MensajesValidacionSubgrupo extends ObjetoMensajeValidacionInterfaz {
  configuracionFormBuilder?: ConfiguracionFormBuilder;
}
