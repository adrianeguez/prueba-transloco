...
export class EmpresaClientesFormulario {
  formGroup: FormGroup;
  mensajesValidacionEmpresaCliente: MensajesValidacionEmpresaClientes;
  mensajesValidacionRazonSocial: MensajesValidacionEmpresaClientes;
  mensajesValidacionRuc: MensajesValidacionEmpresaClientes;
  ...
  constructor(
    ...
    public ruc: string,
    public id?: string, // contenidoConstructor - NO BORRAR ESTA LINEA
  ) {
    this.encerarConfiguracionFormBuilderEmpresaCliente();
    this.encerarConfiguracionFormBuilderRazonSocial();
    this.encerarConfiguracionFormBuilderRuc();
    // contenidoEjecucionConstructor - NO BORRAR ESTA LINEA
  }

  private encerarConfiguracionFormBuilderEmpresaCliente() {
    // empiezaArgumentosEmpresaCliente - NO BORRAR ESTA LINEA
    const argumentos: any = {
      required: true,
      email: false,
      nombre: 'empresaCliente',
      ...
      min: false,
      max: false,
      patternMensaje: 'Error en empresa cliente',
      tipoControl: {
        tipoCampoHtml: 'text',
        tipo: 'autocomplete',
    ...
    // terminaArgumentosEmpresaCliente - NO BORRAR ESTA LINEA

    argumentos.mascara = false;
    argumentos.mascaraFuncion = false;
    argumentos.pattern = false;

    this.mensajesValidacionEmpresaCliente = establecerMensajesDeValidacionComunes(
    ...
    this.mensajesValidacionEmpresaCliente.configuracionFormBuilder = {
      required: {
...
interface MensajesValidacionEmpresaClientes
