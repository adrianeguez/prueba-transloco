import { quitarMascaraNumero } from 'src/app/submodulos/submodulo-articulos-front/funciones/mascara/quitar-mascara-numero';
import { quitarMascaraPrecio } from 'src/app/submodulos/submodulo-articulos-front/funciones/mascara/quitar-mascara-precio';
...
import { PRECIO_MASK_DECIMALES } from '../../../../../submodulo-articulos-front/constantes/mascara';
...
// contenidoEjecucionConstructor - NO BORRAR ESTA LINEA
  ...
  private encerarConfiguracionFormBuilderValor() {
    ...
    const argumentos: any = {
      ...
      ejemplo: 'EJ: 15.00',
      tooltip: 'Ingrese el precio del artículo',
      minLength: false,
      maxLength: false,
      min: false,
      max: false,
  ...
  private encerarConfiguracionFormBuilderValorIncentivo() {
    ...
    const argumentos: any = {
      ...
      ejemplo: 'EJ: 15.00',
      tooltip: 'Ingrese el valor incentivo del artículo',
      minLength: false,
      maxLength: false,
      min: false,
      max: false,
