...
export class CalificacionProveedorFormulario {
  formGroup: FormGroup;
  mensajesValidacionCalificacion: MensajesValidacionCalificacionProveedor;
  mensajesValidacionObservacion: MensajesValidacionCalificacionProveedor;
...
interface MensajesValidacionCalificacionProveedor
