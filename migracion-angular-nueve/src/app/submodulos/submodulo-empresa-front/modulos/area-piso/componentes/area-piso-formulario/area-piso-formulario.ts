...
export class AreaPisoFormulario {
  formGroup: FormGroup;
  mensajesValidacionNombre: MensajesValidacionAreaPiso;
  mensajesValidacionDescripcion: MensajesValidacionAreaPiso;
  mensajesValidacionNivel: MensajesValidacionAreaPiso;
  ...
  private encerarConfiguracionFormBuilderNombre() {
    ...
    const argumentos: any = {
      ...
      ejemplo: 'EJ: Área de ventas',
      tooltip: 'Ingrese el nombre del área',
      minLength: 1,
      maxLength: 30,
      min: false,
      max: false,
  ...
  private encerarConfiguracionFormBuilderDescripcion() {
    ...
    const argumentos: any = {
      ...
      ejemplo: 'EJ: Área de ventas matriz',
...
interface MensajesValidacionAreaPiso extends ObjetoMensajeValidacionInterfaz {
  configuracionFormBuilder?: ConfiguracionFormBuilder;
}
