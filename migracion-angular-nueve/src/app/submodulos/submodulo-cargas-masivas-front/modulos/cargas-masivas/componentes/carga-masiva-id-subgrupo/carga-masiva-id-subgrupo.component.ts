...
@Component({
  selector: 'ml-carga-masiva-id-subgrupo',
  templateUrl: './carga-masiva-id-subgrupo.component.html',
  styleUrls: ['./carga-masiva-id-subgrupo.component.scss'],
})
export class CargaMasivaIdSubgrupoComponent
  ...
  subgrupoSeleccionado: SubgrupoInterface;
  ...
  abrirModal() {
    const ventanaModal = this.dialog.open(ModalListaSubgruposComponent, {
      width: '600px',
    });
