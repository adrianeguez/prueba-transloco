...
@Component({
  selector: 'ml-carga-masiva-id-articulo',
  templateUrl: './carga-masiva-id-articulo.component.html',
  styleUrls: ['./carga-masiva-id-articulo.component.scss'],
})
export class CargaMasivaIdArticuloComponent
  ...
  abrirModal() {
    const ventanaModal = this.dialog.open(ModalListaArticulosComponent, {
      width: '600px',
    });
