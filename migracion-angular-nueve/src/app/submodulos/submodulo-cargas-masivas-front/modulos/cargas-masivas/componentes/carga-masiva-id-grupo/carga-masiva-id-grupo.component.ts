...
@Component({
  selector: 'ml-carga-masiva-id-grupo',
  templateUrl: './carga-masiva-id-grupo.component.html',
  styleUrls: ['./carga-masiva-id-grupo.component.scss'],
})
export class CargaMasivaIdGrupoComponent
  ...
  grupoSeleccionado: GrupoInterface;
  ...
  abrirModal() {
    const ventanaModal = this.dialog.open(ModalListaGruposComponent, {
      width: '600px',
    });
