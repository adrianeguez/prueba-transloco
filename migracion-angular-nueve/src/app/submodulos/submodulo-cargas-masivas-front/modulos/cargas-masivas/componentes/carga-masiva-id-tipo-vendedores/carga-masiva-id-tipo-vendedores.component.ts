...
@Component({
  selector: 'ml-carga-masiva-id-tipo-vendedores',
  templateUrl: './carga-masiva-id-tipo-vendedores.component.html',
  styleUrls: ['./carga-masiva-id-tipo-vendedores.component.scss'],
})
export class CargaMasivaIdTipoVendedoresComponent
  ...
  abrirModal() {
    const ventanaModal = this.dialog.open(ModalListaTipoVendedoresComponent, {
      width: '600px',
    });
