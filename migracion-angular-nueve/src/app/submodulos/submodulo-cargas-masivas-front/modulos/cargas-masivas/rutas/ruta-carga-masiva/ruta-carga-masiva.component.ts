...
@Component({
  selector: 'ml-carga-masiva',
  templateUrl: './ruta-carga-masiva.component.html',
  styleUrls: ['./ruta-carga-masiva.component.sass'],
})
export class RutaCargaMasivaComponent
  ...
  ngOnInit() {
    this._activatedRoute.params.subscribe(params => {
      params.nombreCarga === 'empresa' ||
      params.nombreCarga === 'grupos' ||
      params.nombreCarga === 'tipo-impuestos' ||
      params.nombreCarga === 'usuarios' ||
      params.nombreCarga === 'tipo-vendedores'
        ? (this.requiereId = false)
        : (this.requiereId = true);
  ...
  descargarArchivoEjemplo(nombreCargaMasiva: string) {
    return `assets/cargas-masivas/ejemplos/${nombreCargaMasiva}-ejemplo.xlsx`;
  }

  descargarPlantilla(nombreCargaMasiva: string) {
    return `assets/cargas-masivas/plantillas/${nombreCargaMasiva}.xlsx`;
  }
}
